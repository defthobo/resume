...
\textbf{Frameworks \& Development Tools:} Linux, CUDA, NodeJS, React, Angular, Bootstrap, NeuronxDistributed, vLLM\\
\textbf{Databases:} SQLite, Oracle, MongoDB 

\vspace{1pt}
\cvsection{Work Experience}

\cvevent{Amazon Web Services}{San Jose, USA}{Software Dev Engineer Intern - Machine Learning Chip Accelerator}{NeuronxDistributed, vLLM}{May 2024 -- Aug 2024}
\begin{itemize}
