...
\personalinfo{%
  ...
  \email{\href{mailto:minjiema@usc.edu}{minjiema@usc.edu}} \hspace{-0.4cm}
  \phone{+1 (734) 604-5631} \hspace{-0.4cm}
  \mailaddress{15301 NE Turing St Apt 523, Redmond, WA 98052} \hspace{-0.4cm}
%  \location{Los Angeles, CA 90007}
	\github{\href{https://github.com/defthobo}{GitHub}}
...
\cvsection{Education}
\cveducation{University of Southern California}{Los Angeles, USA}{Master of Science in Computer Science | GPA - 3.81/4.00}{Sep 2023 -- May 2025}
...
\textbf{Languages:} Python, C/C++, SQL, SystemVerilog, JavaScript, TypeScript, Java, Kotlin, Bash Scripting\\
\textbf{Frameworks \& Development Tools:} Pytorch, Numpy, DSPy, AWS CDK, MLflow, NodeJS, React, Angular \\
\textbf{Infra \& Service:} Elastic Kubernetes Cluster, Elastic Container Service, Bedrock, Cloudwatch, FSx

\vspace{1pt}
\cvsection{Work Experience}

\cvevent{Amazon Web Services}{Bellevue, USA}{Software Dev Engineer - GenAI for Kernels}{Bedrock, Kubernetes, DSPy, MLflow}{June 2025 -- Present}
\begin{itemize}
	\item Configured an Elastic K8s cluster on Trainium nodes to benchmark LLM-generated kernel performance.
	\item Architected and benchmarked two multi-agent systems, including instruction-guided RAG agents and self-evolving agents, resulting in a 1.23x average kernel speedup for the superior agentic workflow.
	\item Deployed an MLflow server on ECS with RDS \& S3 backends to analyze optimization trajectories.
...
\begin{itemize}
	...
	\item Designed preprocessing of the embedding mask on CPU\ to avoid tensor materialization and computation graph truncation.
%	\item Optimized Llava inference throughput by integrating paged KV cache technique for efficient memory management.
\end{itemize}
%
