...
\personalinfo{%
  ...
  \mailaddress{15301 NE Turing St Apt 523, Redmond WA 98052}
...
\cvevent{Amazon Web Services}{Bellevue, USA}{Software Dev Engineer - GenAI for Kernels}{Bedrock, Kubernetes, DSPy, MLflow}{June 2025 -- current}
\begin{itemize}
	\item Configured an Elastic K8s cluster on Trainium nodes to benchmark LLM-generated kernel performance.
	\item Architected and benchmarked two multi-agent systems, including instruction-guided RAG agents and self-evolving agents, resulting in a 1.23x average kernel speedup for the superior model.
	\item Deployed an MLflow server with RDS/S3 backends to analyze kernel traces and boost multi-agent system throughput.
